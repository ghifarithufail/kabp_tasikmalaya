...
@section('content')
    <div class="card text-center">
        <h5 class="card-header">Koordinator Tps {{$korlur->nama}}</h5>
    </div>
    <div class="card mt-4">
        <div class="card-header d-flex justify-content-end" style="zoom: 0.8">
            <a href="{{ route('report/korlur/excel', $korlur->id) }}" type="button" class="btn btn-success">Excel</a>
            <a href="{{ route('report/korlur/pdf', $korlur->id) }}" type="button" class="btn btn-danger" target="_blank" id="pdfLink" style="margin-left: 20px;">
                PDF
            </a>
        </div>
