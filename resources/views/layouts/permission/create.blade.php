...
@section('content')
    <div class="card mb-4">
        ...
        @endif
        <div class="card-body">
            <form action="{{ route('konfigurasi/permissions/store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="guard_name" id="guard_name" class="form-control" placeholder="Masukan Guard Name" value="{{ old('guard_name') }}" required style="@if ($errors->has('guard_name')) border-color:red; @endif" />
                        @error('guard_name')
                            <div style="color: red">
                                {{ $message }}
                            </div>
