...
@section('content')
    <div class="card text-center">
        <h5 class="card-header">Log Input Suara </h5>
    </div>
    <div class="card mt-4">
            ...
            <form>
                <div class="form-group row">
                    <div class="col-sm-4 mt-2">
                        <input type="date" class="form-control" placeholder="Date" name="date_start" value="{{ $request['date_start'] }}" id="date_start">
                    </div>
                    <div class="col-sm-4 mt-2">
                        <input type="date" class="form-control" placeholder="Date" name="date_end" value="{{ $request['date_end'] }}" id="date_end">
                    </div>
                    <div class="col-sm-3">
