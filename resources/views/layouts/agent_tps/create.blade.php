...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('koordinator/agent/store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label class="form-label" for="korlur_id">Koordinator Tps</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="tps_id[]" id="tps_id" multiple="multiple">
                    ...
                    processResults: function(data) {
                        return {
                            results: $.map(data, function(item) {
                                return {
                                    id: item.id,
                                    text: item.nama + ' - ' + item.kelurahans.tps.tps + ' - ' + item.kelurahans.nama_kelurahan
                                }
                            })
                        };
                    },
