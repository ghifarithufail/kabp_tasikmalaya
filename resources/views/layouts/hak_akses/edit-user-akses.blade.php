...
@section('content')
    <div class="card mb-4">
        ...
        @endif
        <div class="card-body">
            <form action="{{ route('konfigurasi/hak-akses/user/update', $data->id) }}" method="POST" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                ...
                <div class="col-12">
                    <h4>Users {{ $data->name }} Permissions</h4>
                    <!-- Permission table -->
                                                ...
                                                @foreach ($mm->permissions as $permission)
                                                    <div class="form-check me-3 me-lg-5">
                                                        <input class="form-check-input checkbox-item" type="checkbox" name="permissions[]"
                                                            value="{{ $permission->name }}" @checked($data->hasDirectPermission($permission->name))
                                                            type="checkbox"
